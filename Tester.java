...
public class Tester {
  ...
  public void get(BST ot){
    System.out.println("Testing Get METHOD");
    BST nt = new BSTImpl();
    int[] v1 = new int[]{55,25,105,45,1135,15};
    for (int v:v1) { ot.insert(v); }
    Print.tree(ot);
    System.out.println("Get:" + (ot.get(105)).getValue());


  }
  public void isFullBT(BST ot){
    System.out.println("Testing isFullBT METHOD");
    BST nt = new BSTImpl();
    int[] v1 = new int[]{3,4,5};
    for (int v:v1) { ot.insert(v); }
    Print.tree(ot);
    System.out.println(ot.isFullBT());
  }
  ...
  public void findMin(BST ot){
    System.out.println("FIND MIN TEST");
    int[] v1 = new int[]{55,25,105,45,1135,15};
    for (int v:v1) { ot.insert(v); }
    Print.tree(ot);
    System.out.println("MIN:" + ot.findMin());

  }

  public void findMax(BST ot){
    System.out.println("FIND MAX TEST");
    int[] v1 = new int[]{25,105,45,1135,15};
    for (int v:v1) { ot.insert(v); }
    Print.tree(ot);
    System.out.println("MAX:" + ot.findMax());
  }

  public void getMaxLeafHeightDiff(BST ot){
    System.out.println("GETDIFFERENCE OF MAX HEIGHT");
    int[] v1 = new int[]{1,2,5,55,25,105,45,50,1135,15};
    for (int v:v1) { ot.insert(v); }
    Print.tree(ot);
    System.out.println("Difference of height max:" + ot.getMaxLeafHeightDiff());
  }
